...
public class Global : MonoBehaviour
{
    ...
    public static async UniTask BuildAISceneContent(string street)
    {
        ...
        {
            var prompt = "生成" + street + "横版游戏街景，水平仰视视角，C4D风格，超高清，大师级建筑渲染，真实还原该城市比例与道路结构，远景为该城市山脉，中景包含几个该城市片区特色地标建筑，前景为该城市片区的特色水域（例如江或湾），地标建筑及水域需横向平行于底边，最终图片为横向循环贴图，最右侧内容能无缝拼接最左侧内容，构图整洁，建筑比例精准，色彩多彩鲜明，材质丰富，去掉拼接线，去掉文字";
            var tex = await TextToImage2.SendStreamRequestCommon(prompt);
